...
{
    class T3PythiteGunblade : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Perfect Pythite Gunblade");
        ...
        public override void SetDefaults()
        {
            ...
            item.width = 168;            //Weapon's texture's width
            item.height = 82;           //Weapon's texture's height
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod.ItemType("T3PythiteBarItem"), 10);
